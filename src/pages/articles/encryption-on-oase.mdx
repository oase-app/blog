...
One of the arguments for getting end-to-end-encryption to begin with, was to make sure, that even if you have full access to all Oase infrastructure, which only few people will have, you would have to do an active and complicated effort to be able to read any user data.
...
The strategy we employ to make us deserve your trust, is to use end-to-end encryption and store the cipher text and the keys in different places. This ensures, that in order for someone evil to get your data, they would have to breach two seperate infrastructures.
