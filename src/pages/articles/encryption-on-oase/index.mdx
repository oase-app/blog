...
We want to create that platform that you can trust to be on your side. No hidden agendas. No conflict of interests. An app that has the features you expect and know how to use. An app that will help you&mdash;not harvest your attention.
...
When you communicate using technology, you have to be aware, that you're not only sharing the information with the people at the other end of the conversation. You _also_ share the information with the companies providing the technology. This means that you both delegate trust to the people in your conversation _and_ the company providing the app you communicate within.
...
When running in "the cloud", as we do at Oase, you have _no control_ of the services you use. You might have the illusion of control over eg. the database you get, but you have no control of what is logged where by the provider of that database. This results in a situation where we can show our service providers __no trust__.
...
At Oase, we are keenly aware of the trust that our users place in us when they choose our platform. As a result, we're committed not just to employing state-of-the-art encryption and security measures, but also to implementing strict access controls and auditing procedures within our company.

These measures are designed to monitor and restrict any potential access to user data, thus further minimizing the possibility of unauthorized access or data breaches.

By doing this, we aim to build a system where the theoretical ability to decrypt user messages is tightly controlled and transparent, further enhancing the trust our users can place in us.
