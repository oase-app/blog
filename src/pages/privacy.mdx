...
**Our landing page** at hi.oase.app is served by GitHub Pages (GitHub, Inc., US) through its content delivery network; GitHub logs visitor IP addresses for security purposes under its own privacy statement. On that page we use Plausible Analytics (Plausible Insights OÜ, Estonia), a cookieless analytics service hosted in the EU that never stores IP addresses and cannot identify individual visitors.
...
| GitHub, Inc., US | Hosting of the landing page at hi.oase.app (GitHub Pages); visitor IP addresses logged for security under GitHub's privacy statement |
| Plausible Insights OÜ, Estonia | Cookieless, aggregate analytics on the landing page; EU-hosted, no IP addresses stored |
...
Neither the App nor our websites use cookies or any other tracking mechanisms. The only analytics on our landing page is Plausible, which is cookieless and does not identify individual visitors.
