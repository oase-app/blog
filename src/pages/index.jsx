  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="We're Oase, a community platform built in Copenhagen."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            This is our blog where we share our thoughts, ideas, and stories.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://twitter.com/our_oase"
              aria-label="Follow on Twitter"
              icon={TwitterIcon}
            />
            <SocialLink
              href="https://github.com/oase-app"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/company/our-oase"
